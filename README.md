...
>     12月11日更新：试用各个APP期间为了排版的事情纠结来纠结去，终于忍不住自己写了一套排版算法。心想我只看中文书，中文排版非常好排，而且自己天天忍不住就在关注排版的东西，所以写写很轻松。针对常看的小说做了处理，平常最多下移一个字符，还做了标点压缩。在看小说领域我感觉超过市面上所有的中文排版了！而且完全自己写的，后面想怎么改就怎么改。

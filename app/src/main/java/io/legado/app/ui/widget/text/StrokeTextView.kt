        ...
        when {
            ...
            isBottomBackground -> {
                ...
                background = Selector.shapeBuild()
                    .setCornerRadius(radius)
                    .setStrokeWidth(1.dp)
                    .setDisabledStrokeColor(context.getCompatColor(R.color.readText))
                    .setDefaultStrokeColor(context.getCompatColor(R.color.readText))
                    .setSelectedStrokeColor(context.accentColor)
                    .setPressedBgColor(context.getCompatColor(R.color.readText))
                    .create()
                setTextColor(
                    Selector.colorBuild()
                        .setDefaultColor(context.getCompatColor(R.color.readText))
                        .setSelectedColor(context.accentColor)
                        .setDisabledColor(context.getCompatColor(R.color.readText))
                        .create()
                )
            }
            else -> {
